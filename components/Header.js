    ...
    return (
        <header className={`sticky top-0 z-50 grid grid-cols-3 bg-white py-5 px-5 md:px-10 transition duration-300 ease-out ${show && "bg-opacity-0"} ${!show && "shadow-md"}`} >
            ...
            <div className="flex items-center md:border-2 rounded-full py-2 md:shadow-sm">
                ...
                />
                <SearchIcon className="hidden md:inline-flex h-8 bg-red-400 hover:bg-red-500 transition-colors text-white rounded-full p-2 cursor-pointer md:mx-2" />
            </div>
            ...
            {searchInput && (
               <div className="flex flex-col col-span-3 mx-auto">
                   ...
                   <div className="flex">
                     <button onClick={resetInput} className="flex-grow text-gray-400 hover:text-gray-500 transition-colors ">Cancel</button>
